// What a content type definition is made of.
//
// Field types mirror the backend's enforced set (Core/Validation/FieldTypeRegistry.cs, the single
// source of truth every backend validator reads from). This is the vocabulary a renderer, a
// designer and a CLI all have to agree on, which is why it sits in the package rather than beside
// one consumer's screens.
